...
namespace Riptide
{
  ...
  public class Message
  {
    ...
    {
      throw new Exception("Message only contains {UnreadLength} unread {Helper.CorrectForm(UnreadLength, \"byte\")}, which is not enough to retrieve a value of type '{valueName}'! Returning {defaultReturn}.");
      //return string.Empty;
    }
    ...
    {
      throw new Exception($"Message only contains {UnreadLength} unread {Helper.CorrectForm(UnreadLength, "byte")}, which is not enough to retrieve {arrayLength} {Helper.CorrectForm(arrayLength, valueName)}! Returned array will contain default elements.");
      //return string.Empty;
    }
